...
import { Search, X, Gauge, Users, Activity } from "lucide-react"
import { FiltrosMedidor } from "../types/medidor"

interface FiltrosUsuariosProps {
  filtros: FiltrosMedidor
  onFiltrosChange: (filtros: FiltrosMedidor) => void
...
export default function FiltrosUsuarios({
  ...
  const handleInputChange = (campo: keyof FiltrosMedidor, valor: any) => {
          ...
          <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm">Total Medidores</p>
                  <p className="text-2xl font-bold">{totalMedidores}</p>
                </div>
        ...
        >
          <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-100 text-sm">Medidores Activos</p>
                  <p className="text-2xl font-bold">{medidoresActivos}</p>
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Buscar por numero, nombre o direccion..."
