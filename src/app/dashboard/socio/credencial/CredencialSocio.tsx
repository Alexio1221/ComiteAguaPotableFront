    ...
    return (
      ...
      >
        ...
        <div className="text-center mt-4">
          <h1 className="text-4xl font-bold leading-tight">COMITÉ DE AGUA POTABLE</h1>
          <h1 className="text-4xl font-bold leading-tight">"CATACHILLA ALTA"</h1>
        ...
        <div className="flex-1 rounded-lg p-8 flex justify-between items-center">
          ...
          <div className="space-y-8 flex-1">
            <div>
              <p className="text-2xl font-semibold text-blue-100 mb-2">Nombre:</p>
              <p className="text-4xl font-bold text-white">{nombre} {apellidos}</p>
            </div>

            <div>
              <p className="text-2xl font-semibold text-blue-100 mb-2">N° Socio:</p>
              <p className="text-4xl font-bold text-yellow-300">{idSocio}</p>
            </div>

            <div>
              <p className="text-2xl font-semibold text-blue-100 mb-2">Dirección:</p>
              <p className="text-3xl font-medium text-white">{direccion}</p>
            </div>
          </div>
